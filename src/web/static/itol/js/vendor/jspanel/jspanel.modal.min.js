...
jsPanel.modal || (jsPanel.modal = {
    ...
    addBackdrop: function (e) {
        ...
        return a.id = "jsPanel-modal-backdrop-" + e,
            0 === n ? a.className = "jsPanel-modal-backdrop" : n > 0 && (a.className = "jsPanel-modal-backdrop jsPanel-modal-backdrop-multi"),
            a.style.zIndex = this.ziModal.next(),
            a
    },
    ...
    create: function () {
        ...
        e.paneltype = "modal",
            e.id ? "function" == typeof e.id && (e.id = e.id()) : e.id = "jsPanel-".concat(jsPanel.idCounter += 1);
        var n = e
            , a = this.addBackdrop(n.id);
        return e.config && delete (n = Object.assign({}, e.config, e)).config,
            n = Object.assign({}, this.defaults, n, {
                container: "window"
            }),
            document.body.append(a),
            jsPanel.create(n, function (e) {
                e.style.zIndex = jsPanel.modal.ziModal.next(),
                    e.header.style.cursor = "default",
                    e.footer.style.cursor = "default",
                    n.closeOnBackdrop && jsPanel.pointerup.forEach(function (a) {
                    ...
                    e.options.onclosed.unshift(function () {
                        return jsPanel.modal.removeBackdrop(n.id),
                            !0
                    })
            })
    }
