...
!function (e, t) {
    ...
    !function (e) {
        ...
        function r(t, s) {
            ...
            if (-1 !== e.inArray(r, s))
                return -1 === e.inArray(r, i) || Boolean(t.nodeValue.match(n) || t.nodeValue.match(o));
            ...
            if ("Element" in t) {
                ...
                if (s.defineProperty) {
                    ...
                    try {
                        ...
                        void 0 !== e.number && -2146823252 !== e.number || (o.enumerable = !1,
                            s.defineProperty(i, "classList", o))
                    }
                } else
        ...
        var a, c, d, h = document.createElement("_");
        if (h.classList.add("c1", "c2"),
        ...
        h = null,
            String.prototype.startsWith || (a = function () {
                try {
                    var e = {}
        ...
        function w(e, t, i, s) {
            for (var n = ["display", "subtext", "tokens"], o = !1, r = 0; r < n.length; r++) {
                ...
                if (a && (a = a.toString(),
                    ...
                    s && (a = S(a)),
                    a = a.toUpperCase(),
                    o = "contains" === i ? a.indexOf(t) >= 0 : a.startsWith(t)))
                    break
            }
            return o
        }
        ...
        var x = {
            ...
            , y = RegExp("[\\u0300-\\u036f\\ufe20-\\ufe2f\\u20d0-\\u20ff\\u1ab0-\\u1aff\\u1dc0-\\u1dff]", "g");
        function $(e) {
            return x[e]
        }
        function S(e) {
            return (e = e.toString()) && e.replace(k, $).replace(y, "")
        }
        var E, C, O, z, T, A = (E = {
            "&": "&amp;",
            "<": "&lt;",
            ...
            104: "8",
            105: "9"
        }, N = 27, D = 13, H = 32, P = 9, W = 38, B = 40, M = {
            success: !1,
            major: "3"
        };
        try {
            ...
            , q = {
                ...
                text: function (e, t) {
                    ...
                    if (e.content)
                        ...
                        if (n.textContent = e.text,
                            ...
                            (s = (!0 === t ? F.i : F.span).cloneNode(!1)).className = this.options.iconBase + " " + e.icon,
                ...
                label: function (e) {
                    ...
                    if (s.innerHTML = e.display,
                        ...
                        (i = F.span.cloneNode(!1)).className = this.options.iconBase + " " + e.icon,
        ...
        function Y(i) {
            ...
            if ([].shift.apply(n),
                ...
                try {
                    ...
                    K.BootstrapVersion ? M.full = K.BootstrapVersion.split(" ")[0].split(".") : (M.full = [M.major, "0", "0"],
            ...
            if ("4" === M.major) {
                var r = [];
                K.DEFAULTS.style === j.BUTTONCLASS && r.push({
                    name: "style",
                    className: "BUTTONCLASS"
                }),
                    K.DEFAULTS.iconBase === j.ICONBASE && r.push({
                        name: "iconBase",
                        className: "ICONBASE"
                    }),
                    K.DEFAULTS.tickIcon === j.TICKICON && r.push({
                        name: "tickIcon",
                        className: "TICKICON"
                    }),
                ...
                for (var l = 0; l < r.length; l++) {
                    i = r[l];
                    K.DEFAULTS[i.name] = j[i.className]
                }
            }
            var a = this.each((function () {
                ...
                if (i.is("select")) {
                    ...
                    if (r) {
                        ...
                        var h = e.extend({}, K.DEFAULTS, e.fn.selectpicker.defaults || {}, c, l);
                        h.template = e.extend({}, K.DEFAULTS.template, e.fn.selectpicker.defaults ? e.fn.selectpicker.defaults.template : {}, c.template, l.template),
                            i.data("selectpicker", r = new K(this, h))
                    }
            ...
            K.prototype = {
                    ...
                    R++,
                        ...
                        this.$newElement.on({
                            "hide.bs.dropdown": function (t) {
                                e.$element.trigger("hide" + U, t)
                            },
                            "hidden.bs.dropdown": function (t) {
                                e.$element.trigger("hidden" + U, t)
                            },
                            "show.bs.dropdown": function (t) {
                                e.$element.trigger("show" + U, t)
                            },
                            "shown.bs.dropdown": function (t) {
                                e.$element.trigger("shown" + U, t)
                            }
                        }),
                        e.$element[0].hasAttribute("required") && this.$element.on("invalid" + U, (function () {
                            e.$button[0].classList.add("bs-invalid"),
                                e.$element.on("shown" + U + ".invalid", (function () {
                                    e.$element.val(e.$element.val()).off("shown" + U + ".invalid")
                                }
                                )).on("rendered" + U, (function () {
                                    this.validity.valid && e.$button[0].classList.remove("bs-invalid"),
                                        e.$element.off("rendered" + U)
                                }
                                )),
                                e.$button.on("blur" + U, (function () {
                ...
                createDropdown: function () {
                    ...
                    return this.options.header && (r = '<div class="' + j.POPOVERHEADER + '"><button type="button" class="close" aria-hidden="true">&times;</button>' + this.options.header + "</div>"),
                        this.options.liveSearch && (l = '<div class="bs-searchbox"><input type="search" class="form-control" autocomplete="off"' + (null === this.options.liveSearchPlaceholder ? "" : ' placeholder="' + A(this.options.liveSearchPlaceholder) + '"') + ' role="combobox" aria-label="Search" aria-controls="' + this.selectId + '" aria-autocomplete="list"></div>'),
                        ...
                        this.multiple && this.options.doneButton && (c = '<div class="bs-donebutton"><div class="btn-group btn-block"><button type="button" class="btn btn-sm ' + j.BUTTONCLASS + '">' + this.options.doneButtonText + "</button></div></div>"),
                        o = '<div class="dropdown bootstrap-select' + t + s + '"><button type="button" class="' + this.options.styleBase + ' dropdown-toggle" ' + ("static" === this.options.display ? 'data-display="static"' : "") + 'data-toggle="dropdown"' + n + ' role="combobox" aria-owns="' + this.selectId + '" aria-haspopup="listbox" aria-expanded="false"><div class="filter-option"><div class="filter-option-inner"><div class="filter-option-inner-inner"></div></div> </div>' + ("4" === M.major ? "" : '<span class="bs-caret">' + this.options.template.caret + "</span>") + '</button><div class="' + j.MENU + " " + ("4" === M.major ? "" : j.SHOW) + '">' + r + l + a + '<div class="inner ' + j.SHOW + '" role="listbox" id="' + this.selectId + '" tabindex="-1" ' + i + '><ul class="' + j.MENU + " inner " + ("4" === M.major ? j.SHOW : "") + '" role="presentation"></ul></div>' + c + "</div></div>",
                        e(o)
                },
                ...
                createView: function (t, i, s) {
                    ...
                    function f(e, i) {
                        var s, a, d, h, p, u, f, m, v, g, b = r.selectpicker.current.elements.length, w = [], I = !0, x = r.isVirtual();
                        ...
                        for (var k = 0; k < a; k++) {
                            ...
                            if (k === a - 1 && (y = b),
                                ...
                                !b)
                                break;
                            void 0 === p && e - 1 <= r.selectpicker.current.data[y - 1].position - r.sizeInfo.menuInnerHeight && (p = k)
                        }
                        if (void 0 === p && (p = 0),
                            u = [r.selectpicker.view.position0, r.selectpicker.view.position1],
                            d = Math.max(0, p - 1),
                            h = Math.min(a - 1, p + 1),
                            r.selectpicker.view.position0 = !1 === x ? 0 : Math.max(0, w[d][0]) || 0,
                            r.selectpicker.view.position1 = !1 === x ? b : Math.min(b, w[h][1]) || 0,
                            ...
                            (i || f) && (m = r.selectpicker.view.visibleElements ? r.selectpicker.view.visibleElements.slice() : [],
                                r.selectpicker.view.visibleElements = !1 === x ? r.selectpicker.current.elements : r.selectpicker.current.elements.slice(r.selectpicker.view.position0, r.selectpicker.view.position1),
                                r.setOptionStatus(),
                                (t || !1 === x && i) && (v = m,
                                ...
                                (i || !0 === x) && I)) {
                            var $, S, E = r.$menuInner[0], C = document.createDocumentFragment(), O = E.firstChild.cloneNode(!1), z = r.selectpicker.view.visibleElements, T = [];
                            E.replaceChild(O, E.firstChild);
                            k = 0;
                            for (var A = z.length; k < A; k++) {
                                var L, N, D = z[k];
                                r.options.sanitize && (L = D.lastChild) && (N = r.selectpicker.current.data[k + r.selectpicker.view.position0]) && N.content && !N.sanitized && (T.push(L),
                                    N.sanitized = !0),
                                    C.appendChild(D)
                            }
                            if (r.options.sanitize && T.length && l(T, r.options.whiteList, r.options.sanitizeFn),
                                !0 === x ? ($ = 0 === r.selectpicker.view.position0 ? 0 : r.selectpicker.current.data[r.selectpicker.view.position0 - 1].position,
                                    S = r.selectpicker.view.position1 > b - 1 ? 0 : r.selectpicker.current.data[b - 1].position - r.selectpicker.current.data[r.selectpicker.view.position1 - 1].position,
                                    E.firstChild.style.marginTop = $ + "px",
                                    E.firstChild.style.marginBottom = S + "px") : (E.firstChild.style.marginTop = 0,
                                        E.firstChild.style.marginBottom = 0),
                                E.firstChild.appendChild(C),
                                !0 === x && r.sizeInfo.hasScrollBar) {
                                var H = E.firstChild.offsetWidth;
                                if (i && H < r.sizeInfo.menuInnerInnerWidth && r.sizeInfo.totalMenuWidth > r.sizeInfo.selectWidth)
                                    E.firstChild.style.minWidth = r.sizeInfo.menuInnerInnerWidth + "px";
                        ...
                        if (r.prevActiveIndex = r.activeIndex,
                            ...
                            if (t && i) {
                                var W, B = 0;
                                r.selectpicker.view.canHighlight[B] || (B = 1 + r.selectpicker.view.canHighlight.slice(1).indexOf(!0)),
                                    W = r.selectpicker.view.visibleElements[B],
                                    r.defocusItem(r.selectpicker.view.currentActive),
                                    r.activeIndex = (r.selectpicker.current.data[B] || {}).index,
                                    r.focusItem(W)
                            }
                        } else
                    ...
                    f(a, !0),
                        ...
                        e(window).off("resize" + U + "." + this.selectId + ".createView").on("resize" + U + "." + this.selectId + ".createView", (function () {
                    ...
                    function r(e, i) {
                        if ((i = i || {}).divider = "true" === e.getAttribute("data-divider"),
                            ...
                            var s = t.length
                                , n = e.style.cssText
                                , r = n ? A(n) : ""
                                , l = (e.className || "") + (i.optgroupClass || "");
                            i.optID && (l = "opt " + l),
                                i.optionClass = l.trim(),
                                i.inlineStyle = r,
                    ...
                    function l(s, n) {
                        ...
                        if (d.length) {
                            ...
                            for (var f = 0, m = d.length; f < m; f++) {
                                var v = d[f];
                                0 === f && (p = (h = t.length - 1) + m),
                                    r(v, {
                                        headerIndex: h,
                                        lastIndex: p,
                                        optID: u.optID,
                                        optgroupClass: u.optgroupClass,
                                        disabled: l.disabled
                                    })
                            }
                            c && o({
                ...
                buildList: function () {
                    ...
                    function n(t) {
                        ...
                        switch (t.type) {
                            case "divider":
                                n = q.li(!1, j.DIVIDER, t.optID ? t.optID + "div" : void 0);
                                break;
                            case "option":
                                (n = q.li(q.a(q.text.call(e, t), t.optionClass, t.inlineStyle), "", t.optID)).firstChild && (n.firstChild.id = e.selectId + "-" + t.index);
                                break;
                            case "optgroup-label":
                                n = q.li(q.label.call(e, t), "dropdown-header" + t.optgroupClass, t.optID)
                        }
                        i.push(n),
                    ...
                    !e.options.showTick && !e.multiple || F.checkMark.parentNode || (F.checkMark.className = this.options.iconBase + " " + e.options.tickIcon + " check-mark",
                ...
                render: function () {
                    var e, t, i = this.$element[0], s = this.setPlaceholder() && 0 === i.selectedIndex, n = m(i, this.options.hideDisabled), o = n.length, r = this.$button[0], a = r.querySelector(".filter-option-inner-inner"), c = document.createTextNode(this.options.multipleSeparator), d = F.fragment.cloneNode(!1), h = !1;
                    if (r.classList.toggle("bs-placeholder", this.multiple ? !o : !v(i, n)),
                        this.tabIndex(),
                        "static" === this.options.selectedTextFormat)
                        d = q.text.call(this, {
                            text: this.options.title
                        }, !0);
                    else if ((e = this.multiple && -1 !== this.options.selectedTextFormat.indexOf("count") && o > 1) && (e = (t = this.options.selectedTextFormat.split(">")).length > 1 && o > t[1] || 1 === t.length && o >= 2),
                        !1 === e) {
                        if (!s) {
                            for (var p = 0; p < o && p < 50; p++) {
                                var u = n[p]
                                    , f = this.selectpicker.main.data[u.liIndex]
                                    , g = {};
                                this.multiple && p > 0 && d.appendChild(c.cloneNode(!1)),
                                    u.title ? g.text = u.title : f && (f.content && this.options.showContent ? (g.content = f.content.toString(),
                                        h = !0) : (this.options.showIcon && (g.icon = f.icon),
                                            this.options.showSubtext && !this.multiple && f.subtext && (g.subtext = " " + f.subtext),
                                            g.text = u.textContent.trim())),
                                    d.appendChild(q.text.call(this, g, !0))
                            }
                    ...
                    if (null == this.options.title && (this.options.title = this.$element.attr("title")),
                        d.childNodes.length || (d = q.text.call(this, {
                        ...
                        this.options.sanitize && h && l([d], this.options.whiteList, this.options.sanitizeFn),
                        a.innerHTML = "",
                        a.appendChild(d),
                        ...
                        k.className = "filter-expand",
                            x ? r.replaceChild(k, x) : r.appendChild(k)
                    }
                ...
                liHeight: function (t) {
                    if (t || !1 !== this.options.size && !Object.keys(this.sizeInfo).length) {
                        var i = document.createElement("div")
                            ...
                            , h = this.options.header && this.$menu.find("." + j.POPOVERHEADER).length > 0 ? this.$menu.find("." + j.POPOVERHEADER)[0].cloneNode(!0) : null
                        ...
                        if (this.sizeInfo.selectWidth = this.$newElement[0].offsetWidth,
                            ...
                            i.className = this.$menu[0].parentNode.className + " " + j.SHOW,
                            i.style.width = 0,
                            "auto" === this.options.width && (s.style.minWidth = 0),
                            s.className = j.MENU + " " + j.SHOW,
                            n.className = "inner " + j.SHOW,
                            o.className = j.MENU + " inner " + ("4" === M.major ? j.SHOW : ""),
                        ...
                        var g, b = a.offsetHeight, w = l ? l.offsetHeight : 0, x = h ? h.offsetHeight : 0, k = p ? p.offsetHeight : 0, y = u ? u.offsetHeight : 0, $ = f ? f.offsetHeight : 0, S = e(r).outerHeight(!0), E = !!window.getComputedStyle && window.getComputedStyle(s), C = s.offsetWidth, O = E ? null : e(s), z = {
                ...
                setMenuSize: function (e) {
                    ...
                    if (this.options.dropupAuto && (l = d * this.selectpicker.current.elements.length + v.vert,
                        ...
                        this.$newElement.toggleClass(j.DROPUP, a),
                        this.selectpicker.dropup = a),
                        "auto" === this.options.size)
                        n = this.selectpicker.current.elements.length > 3 ? 3 * this.sizeInfo.liHeight + this.sizeInfo.menuExtras.vert - 2 : 0,
                ...
                setWidth: function () {
                    ...
                    "auto" === this.options.width ? requestAnimationFrame((function () {
                        e.$menu.css("min-width", "0"),
                            e.$element.on("loaded" + U, (function () {
                                e.liHeight(),
                                    e.setMenuSize();
                ...
                selectPosition: function () {
                    ...
                    var t, i, s, n = this, o = e(this.options.container), r = function (r) {
                        ...
                        n.$bsContainer.addClass(r.attr("class").replace(/form-control|fit-width/gi, "")).toggleClass(j.DROPUP, r.hasClass(j.DROPUP)),
                            t = r.offset(),
                            o.is("body") ? i = {
                                top: 0,
                                left: 0
                            ...
                            (M.major < 4 || "static" === a) && (l.top = t.top - i.top + s,
                    ...
                    this.$button.on("click.bs.dropdown.data-api", (function () {
                        n.isDisabled() || (r(n.$newElement),
                            n.$bsContainer.appendTo(n.options.container).toggleClass(j.SHOW, !n.$button.hasClass(j.SHOW)).append(n.$menu))
                    }
                    )),
                        e(window).off("resize" + U + "." + this.selectId + " scroll" + U + "." + this.selectId).on("resize" + U + "." + this.selectId + " scroll" + U + "." + this.selectId, (function () {
                            n.$newElement.hasClass(j.SHOW) && r(n.$newElement)
                        }
                        )),
                    ...
                    if (this.noScroll = !1,
                        ...
                        for (var t = 0; t < this.selectpicker.view.visibleElements.length; t++) {
                            var i = this.selectpicker.current.data[t + this.selectpicker.view.position0]
                                , s = i.option;
                            s && (!0 !== e && this.setDisabled(i.index, i.disabled),
                                this.setSelected(i.index, s.selected))
                        }
                },
                ...
                clickListener: function () {
                    ...
                    i.data("spaceSelect", !1),
                        ...
                        this.$newElement.on("show.bs.dropdown", (function () {
                            M.major > 3 && !t.dropdown && (t.dropdown = t.$button.data("bs.dropdown"),
                        ...
                        this.$element.on("shown" + U, (function () {
                            t.$menuInner[0].scrollTop !== t.selectpicker.view.scrollTop && (t.$menuInner[0].scrollTop = t.selectpicker.view.scrollTop),
                                M.major > 3 ? requestAnimationFrame(n) : s()
                        }
                        )),
                        ...
                        this.$menuInner.on("click", "li a", (function (i, s) {
                            ...
                            if (t.multiple && 1 !== t.options.maxOptions && i.stopPropagation(),
                                i.preventDefault(),
                                !t.isDisabled() && !n.parent().hasClass(j.DISABLED)) {
                                var u = l.option
                                    , f = e(u)
                                    , g = u.selected
                                    , w = f.parent("optgroup")
                                ...
                                if (a === t.activeIndex && (s = !0),
                                    ...
                                    if (u.selected = !g,
                                        ...
                                        !1 !== x || !1 !== k) {
                                        var y = x < m(o).length
                                            , $ = k < w.find("option:selected").length;
                                        if (x && y || k && $)
                                            if (x && 1 == x)
                                                o.selectedIndex = -1,
                                                    u.selected = !0,
                                                ...
                                                O[2] && (z = z.replace("{var}", O[2][x > 1 ? 0 : 1]),
                                                    T = T.replace("{var}", O[2][k > 1 ? 0 : 1])),
                                                    u.selected = !1,
                                                    t.$menu.append(A),
                                                    x && y && (A.append(e("<div>" + z + "</div>")),
                                                        p = !1,
                                                        t.$element.trigger("maxReached" + U)),
                                                    k && $ && (A.append(e("<div>" + T + "</div>")),
                                                        p = !1,
                                                        t.$element.trigger("maxReachedGrp" + U)),
                                                    setTimeout((function () {
                                                        t.setSelected(a, !1)
                                                    }
                                                    ), 10),
                                ...
                                !t.multiple || t.multiple && 1 === t.options.maxOptions ? t.$button.trigger("focus") : t.options.liveSearch && t.$searchbox.trigger("focus"),
                                    p && (t.multiple || d !== o.selectedIndex) && (b = [u.index, f.prop("selected"), c],
                        ...
                        this.$searchbox.on("input propertychange", (function () {
                            ...
                            if (e.selectpicker.search.elements = [],
                                ...
                                for (var c = 0; c < e.selectpicker.main.data.length; c++) {
                                    ...
                                    o[c] || (o[c] = w(d, n, l, a)),
                                        o[c] && void 0 !== d.headerIndex && -1 === r.indexOf(d.headerIndex) && (d.headerIndex > 0 && (o[d.headerIndex - 1] = !0,
                ...
                val: function (e) {
                    ...
                    if ("undefined" != typeof e) {
                        var i = v(t);
                        if (b = [null, null, i],
                            this.$element.val(e).trigger("changed" + U, b),
                ...
                keydown: function (t) {
                    var i, s, n, o, r, l = e(this), a = l.hasClass("dropdown-toggle"), c = (a ? l.closest(".dropdown") : l.closest(V.MENU)).data("this"), d = c.findLis(), h = !1, p = t.which === P && !a && !c.options.selectOnTab, u = _.test(t.which) || p, f = c.$menuInner[0].scrollTop, m = !0 === c.isVirtual() ? c.selectpicker.view.position0 : 0;
                    if (!(t.which >= 112 && t.which <= 123))
                        if (!(s = c.$newElement.hasClass(j.SHOW)) && (u || t.which >= 48 && t.which <= 57 || t.which >= 96 && t.which <= 105 || t.which >= 65 && t.which <= 90) && (c.$button.trigger("click.bs.dropdown.data-api"),
                            c.options.liveSearch))
                            c.$searchbox.trigger("focus");
                        else {
                            if (t.which === N && s && (t.preventDefault(),
                                ...
                                -1 !== (i = (n = c.selectpicker.main.elements[c.activeIndex]) ? Array.prototype.indexOf.call(n.parentElement.children, n) : -1) && c.defocusItem(n),
                                    t.which === W ? (-1 !== i && i--,
                                        i + m < 0 && (i += d.length),
                                        c.selectpicker.view.canHighlight[i + m] || -1 === (i = c.selectpicker.view.canHighlight.slice(0, i + m).lastIndexOf(!0) - m) && (i = d.length - 1)) : (t.which === B || p) && (++i + m >= c.selectpicker.view.canHighlight.length && (i = 0),
                                            c.selectpicker.view.canHighlight[i + m] || (i = i + 1 + c.selectpicker.view.canHighlight.slice(i + m + 1).indexOf(!0))),
                                    t.preventDefault();
                                var v = m + i;
                                t.which === W ? 0 === m && i === d.length - 1 ? (c.$menuInner[0].scrollTop = c.$menuInner[0].scrollHeight,
                                    v = c.selectpicker.current.elements.length - 1) : h = (r = (o = c.selectpicker.current.data[v]).position - o.height) < f : (t.which === B || p) && (0 === i ? (c.$menuInner[0].scrollTop = 0,
                                        v = 0) : h = (r = (o = c.selectpicker.current.data[v]).position - c.sizeInfo.menuInnerHeight) > f),
                            ...
                            } else if (!l.is("input") && !G.test(t.which) || t.which === H && c.selectpicker.keydown.keyHistory) {
                                var g, b, I = [];
                                t.preventDefault(),
                                ...
                                if (I.length) {
                                    ...
                                    d.removeClass("active").find("a").removeClass("active"),
                                        1 === b.length && (-1 === (y = I.indexOf(c.activeIndex)) || y === I.length - 1 ? y = 0 : y++),
                                        g = I[y],
                                        f - (o = c.selectpicker.main.data[g]).position > 0 ? (r = o.position - o.height,
                                            h = !0) : (r = o.position - c.sizeInfo.menuInnerHeight,
                            ...
                            s && (t.which === H && !c.selectpicker.keydown.keyHistory || t.which === D || t.which === P && c.options.selectOnTab) && (t.which !== H && t.preventDefault(),
                                c.options.liveSearch && t.which === H || (c.$menuInner.find(".active a").trigger("click", !0),
                                    l.trigger("focus"),
                ...
                destroy: function () {
                    this.$newElement.before(this.$element).remove(),
                        ...
                        e(window).off(U + "." + this.selectId)
                }
            };
        var Z = e.fn.selectpicker;
        e.fn.selectpicker = Y,
            e.fn.selectpicker.Constructor = K,
            e.fn.selectpicker.noConflict = function () {
                return e.fn.selectpicker = Z,
                    this
            }
            ;
        var J = e.fn.dropdown.Constructor._dataApiKeydownHandler || e.fn.dropdown.Constructor.prototype.keydown;
        e(document).off("keydown.bs.dropdown.data-api").on("keydown.bs.dropdown.data-api", ':not(.bootstrap-select) > [data-toggle="dropdown"]', J).on("keydown.bs.dropdown.data-api", ":not(.bootstrap-select) > .dropdown-menu", J).on("keydown" + U, '.bootstrap-select [data-toggle="dropdown"], .bootstrap-select [role="listbox"], .bootstrap-select .bs-searchbox input', K.prototype.keydown).on("focusin.modal", '.bootstrap-select [data-toggle="dropdown"], .bootstrap-select [role="listbox"], .bootstrap-select .bs-searchbox input', (function (e) {
            ...
            e(window).on("load" + U + ".data-api", (function () {
