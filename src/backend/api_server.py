...
# 注册基因组拼接与数据库管理路由
from .routes import assembly, database, analysis, annotation, protein_compare, pan_genomics, sanger_trace
...
app.include_router(pan_genomics.router, prefix="/api")
app.include_router(sanger_trace.router)
